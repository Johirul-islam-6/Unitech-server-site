...
const eventQuerysServices = (filtering, paginationOption) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield file_model_1.AcademicCourseModel.find(whereConditons)
        .sort(sortConditions)
        .skip(skip)
        .limit(limit);
    //total modal/collection data length
    const total = yield file_model_1.AcademicCourseModel.countDocuments();
    return {
        meta: {
            page,
            limit,
...
const editeServices = (id, updateEventData) => __awaiter(void 0, void 0, void 0, function* () {
    const updateEvent = yield file_model_1.AcademicCourseModel.findByIdAndUpdate(id, updateEventData, {
        new: true,
    });
    if (!updateEvent) {
...
const updateStatus = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isExist = yield file_model_1.AcademicCourseModel.findOne({ _id: objectId });
    if (!isExist) {
        throw new Error("Book doesn't match Id");
    }
    // Update the ruler field
    const result = yield file_model_1.AcademicCourseModel.findOneAndUpdate({ _id: objectId }, { status: data }, { new: true });
    return result;
});
// --- view count---
const viewCount = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield file_model_1.AcademicCourseModel.findOneAndUpdate({ _id: objectId }, { view: currentView }, { new: true });
    return result;
});
